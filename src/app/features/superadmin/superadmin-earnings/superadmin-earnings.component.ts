...
@Component({
    selector: 'app-superadmin-earnings',
    templateUrl: './superadmin-earnings.component.html',
    styleUrls: ['./superadmin-earnings.component.scss'],
    imports:[CommonModule,RouterLink,NgApexchartsModule,BsDatepickerModule,DateRangePickerComponent] 
})
export class SuperadminEarningsComponent implements OnInit {
