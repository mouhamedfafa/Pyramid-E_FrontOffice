...
@Component({
  selector: 'app-superadmin-payouts',
  ...
  templateUrl: './superadmin-payouts.component.html',
  styleUrl: './superadmin-payouts.component.scss'
})
export class SuperadminPayoutsComponent {
  routes=routes
