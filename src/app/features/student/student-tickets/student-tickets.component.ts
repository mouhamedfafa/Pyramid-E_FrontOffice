...
import { apiResultFormat, instructorTicket, pageSelection } from '../../../shared/models/model';
...
@Component({
    ...
    imports : [CommonModule,MatSortModule,MatSelectModule,CustomPaginationComponent,FormsModule]
})
