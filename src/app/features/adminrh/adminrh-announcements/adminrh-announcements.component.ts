...
@Component({
    selector: 'app-adminrh-announcements',
    templateUrl: './adminrh-announcements.component.html',
    styleUrl: './adminrh-announcements.component.scss',
    imports:[CommonModule,MatTableModule,MatSortModule,MatPaginatorModule,MatSelectModule,FormsModule]
})
export class AdminrhAnnouncementsComponent {
