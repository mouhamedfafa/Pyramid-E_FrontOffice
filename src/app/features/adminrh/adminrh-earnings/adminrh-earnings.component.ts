...
@Component({
    selector: 'app-adminrh-earnings',
    templateUrl: './adminrh-earnings.component.html',
    styleUrls: ['./adminrh-earnings.component.scss'],
    imports:[CommonModule,RouterLink,NgApexchartsModule,BsDatepickerModule,DateRangePickerComponent] 
})
export class AdminrhEarningsComponent implements OnInit {
