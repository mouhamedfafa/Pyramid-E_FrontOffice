...
@Component({
    selector: 'app-adminrh-change-password',
    templateUrl: './adminrh-change-password.component.html',
    styleUrl: './adminrh-change-password.component.scss',
    imports:[CommonModule,FormsModule]
})
export class AdminrhChangePasswordComponent {
