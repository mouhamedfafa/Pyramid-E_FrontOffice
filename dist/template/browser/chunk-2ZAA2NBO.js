...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MesCataloguesDetailsComponent, [{
    type: Component,
    args: [{ standalone: true, selector: "app-mes-catalogues-details", imports: [CommonModule], template: `<!-- LOADER -->\r
<div class="qq-loading" *ngIf="loading">\r
  <div class="qq-loading__ring">\r
    <div></div><div></div><div></div><div></div>\r
  </div>\r
  <p>Chargement des formations du catalogue...</p>\r
</div>\r
\r
<!-- ERREUR -->\r
...
\r
          ...
          <nav class="pad-breadcrumb mb-3">\r
            ...
            <span class="pad-breadcrumb__current">{{ catalogue?.titre || 'Catalogue' }}</span>\r
          </nav>\r
\r
          <!-- Badges -->\r
          <div class="pad-hero__badges mb-3">\r
            ...
            <span class="pad-badge"\r
              ...
              {{ source === 'demande' ? 'Demande accept\xE9e' : 'Assign\xE9' }}\r
            </span>\r
            <span class="pad-badge pad-badge--cat" *ngIf="catalogue?.type">\r
              <i class="isax isax-category me-1"></i>{{ catalogue.type_display || catalogue.type }}\r
            </span>\r
            <span class="pad-badge pad-badge--count">\r
              <i class="isax isax-book-1 me-1"></i>{{ totalFormations }} formation(s)\r
            </span>\r
...
\r
          <h1 class="pad-hero__title">{{ catalogue?.titre || 'Catalogue' }}</h1>\r
          <p class="pad-hero__subtitle" *ngIf="catalogue?.description">{{ catalogue.description }}</p>\r
\r
          <!-- Infos date -->\r
          <div class="pad-hero__assignation mt-3">\r
            <span *ngIf="catalogue?.date_assignation">\r
              <i class="isax me-1"\r
                 [class.isax-calendar-add]="source !== 'demande'"\r
                 [class.isax-tick-circle]="source === 'demande'"></i>\r
              {{ source === 'demande' ? 'Valid\xE9e le' : 'Assign\xE9 le' }}\r
              {{ catalogue.date_assignation | date:'dd/MM/yyyy' }}\r
            </span>\r
            <span *ngIf="!catalogue?.date_expiration" class="pad-permanent">\r
            ...
            <span *ngIf="!estExpire && catalogue?.date_expiration && !isExpiringSoon(catalogue.date_expiration)">\r
              <i class="isax isax-calendar-remove me-1"></i>\r
              Expire le {{ catalogue.date_expiration | date:'dd/MM/yyyy' }}\r
            </span>\r
            <span *ngIf="!estExpire && isExpiringSoon(catalogue?.date_expiration)" class="pad-warning">\r
              <i class="isax isax-warning-2 me-1"></i>\r
              Expire dans {{ getJoursRestants(catalogue.date_expiration) }} jour(s) !\r
            </span>\r
          </div>\r
\r
          <!-- PROGRESSION GLOBALE -->\r
      ...
      <div class="pad-expire-banner__inner">\r
        ...
        <div class="pad-expire-banner__text">\r
          ...
          <span>\r
            ...
            <strong>{{ catalogue.date_expiration | date:'dd/MM/yyyy' }}</strong>.\r
...
\r
      <div class="row g-4" *ngIf="!loading && formations.length > 0">\r
        <div class="col-xl-4 col-md-6" *ngFor="let f of formationsFiltrees; let i = index">\r
\r
          <!-- Carte -->\r
...
\r
            ...
            <div class="pad-formation-card__body">\r
              ...
              <div class="pad-formation-card__meta">\r
                ...
                <span class="pad-meta-chip pad-meta-chip--cert" *ngIf="f.est_obligatoire">\r
                  <i class="isax isax-star me-1"></i>Obligatoire\r
                </span>\r
              </div>\r
\r
              <!-- Barre progression -->\r
...
\r
      <div class="sc-empty" *ngIf="!loading && formations.length === 0">\r
        ...
        <p>Ce catalogue ne contient pas encore de formations publi\xE9es.</p>\r
      </div>\r
\r
    </div>\r
  </section>\r
...
//# sourceMappingURL=chunk-2ZAA2NBO.js.map
